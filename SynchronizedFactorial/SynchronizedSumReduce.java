...
public class SynchronizedSumReduce implements Runnable{
	...
	public static void main(String[] args){
		...
		Thread t5 = new Thread(new SynchronizedSumReduce(intList4));
		Thread t6 = new Thread(new SynchronizedSumReduce(intList4));
		Thread t7 = new Thread(new SynchronizedSumReduce(intList4));
		Thread t8 = new Thread(new SynchronizedSumReduce(intList4));
		Thread t9 = new Thread(new SynchronizedSumReduce(intList4));
